...
<?php
    ...
    if (isset($_POST["submit"])) {
        ...
        // This is where your UPDATE SQL query will go later to change the password!
        // $new_password = $_POST['new_password'];
        // $hashed_password = password_hash($new_password, PASSWORD_DEFAULT);
        // ... (SQL logic here) ...

        // For now, it just redirects straight to the success page to maintain your flow
...
<html lang="en">
    ...
    <body class="login-body">
        <div class="box">
            ...
            <p class="password-hint">* Must be at least 8 chars with uppercase, lowercase, numbers & symbols.</p>
            ...
            <div class="form-group">
                ...
                <button type="submit" name="submit" class="btn-outline">Update</button>
            </form>
            
            <a href="StudentLogin.php" class="cancel-btn">Cancel</a>
        </div>
    </body>
</html>